...
urlpatterns = [
    ...
    path('social/', views.SocialLinkView.as_view({'get': 'list',
                                                  'post': 'create',
                                                  })),
    path('social/<int:pk>', views.SocialLinkView.as_view({'put': 'update',
                                                          'delete': 'destroy',
                                                          })),

    path('google-login/', auth_views.google_login),
    path('google-auth/', auth_views.google_auth),

    path('spotify-login/', auth_views.spotify_login),
    path('spotify-auth/', auth_views.spotify_auth),
